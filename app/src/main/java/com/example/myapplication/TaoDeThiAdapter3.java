...
public class TaoDeThiAdapter3 extends RecyclerView.Adapter<TaoDeThiAdapter3.CauHoiViewHolder> implements Filterable
{
    ...
    public TaoDeThiAdapter3(ArrayList<taodethicauhoiitem> mylist, IClickCauHoiItemListener iClickCauHoiItemListener)
    {
        this.mylist = mylist;
    ...
    @NonNull
    @Override
    public TaoDeThiAdapter3.CauHoiViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        View view =  LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_tao_cau_hoi_cau_hoi_item,parent,false);
        return new TaoDeThiAdapter3.CauHoiViewHolder(view);
    }
